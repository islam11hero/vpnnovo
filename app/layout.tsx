...
export const metadata: Metadata = {
  title: 'IPNOVA | Premium Stealth VPN - Zero Limits',
  description: 'Unblock VoIP calls, eliminate IPTV buffering, and browse securely. Military-grade encryption with ultra-low latency servers.',
  keywords: 'VPN, Stealth VPN, unblock VoIP, fast streaming VPN, IPNOVA, secure internet, bypass ISP',
};
