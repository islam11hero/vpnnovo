        ...
        >
          ...
          >
            ...
            <motion.h1
              ...
              className="mb-8 font-poppins text-4xl font-black leading-[1.08] tracking-tight text-white md:text-5xl lg:text-6xl"
            >
            ...
            <motion.p
              ...
              className="mx-auto mb-12 max-w-xl text-lg font-medium leading-relaxed text-slate-400 lg:mx-0 md:text-xl"
            >
            ...
            >
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.98 }}
                className="flex w-full items-center justify-center rounded-full border border-slate-700 bg-slate-900/80 px-8 py-4 text-sm font-black text-slate-200 transition sm:w-auto"
              >
                Talk to Sales
              </motion.a>
            </motion.div>
